...
## Ansvarsområden:
Data & EDA (target-fördelning, missing values, 2 figurer + insikter) - **Magdalena**
Pipeline & preprocessing (leakage-säker, hantering av numeriskt/kategoriskt, reproducibility) - **Axel**
